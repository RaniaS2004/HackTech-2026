...
import { FingerprintIcon, KeyIcon, ShieldIcon } from "./icons";
    ...
    <section id="how" className="relative py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <h2 className="text-balance text-4xl font-semibold tracking-tight sm:text-5xl">Two challenges. One identity layer.</h2>
        </div>
        ...
        <div className="mx-auto mt-5 max-w-2xl">
          <FeatureCard
            ...
            description="Identifies which AI model is visiting from timing and behavior patterns alone."
          />
        </div>
      </div>
    </section>
